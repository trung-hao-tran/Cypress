...
export const manageSubscriptionStatusChange = async (
  ...
  try {
    ...
    if (!customerData) {
      console.log('[WARNING] Customer not found, skipping subscription update:', customerId);
      return;
    }
    ...
    // Stripe moved period fields to items.data level (breaking change in 2025)
    ...
    console.log('[WEBHOOK] Period fields from items.data[0]:', {
    ...
    const subscriptionData: Subscription = {
      ...
      //@ts-ignore - Stripe type definitions may be stricter in newer versions
