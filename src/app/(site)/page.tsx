...
import ShuffleCards from '@/components/landing-page/shuffle-cards';
      ...
      >
        ...
        />
          ...
          >
            ...
            "
            >
        <Link href="/signup" className="sm:w-[300px]">
              Get Cypress Free
        </Link>
            </Button>
          </div>
